export default function LinkModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-filter backdrop-blur-sm bg-gray-900 bg-opacity-50">
      <div className="bg-background shadow w-5/12 sm:rounded-lg lg:max-w-2xl">
        <div className="flex flex-col px-4 py-5 sm:p-12">
          <h3 className="text-xl font-semibold leading-6 text-modalTitle text-left">
            Add Link
          </h3>
          <form
          ...
          >
            <div className="w-full">
              ...
              <input
                name="url"
                id="url"
                className="block w-full rounded-md border-0 py-1.5 text-text shadow-sm ring-1 ring-inset bg-background ring-inputField placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
              ...
              <div className="flex items-center justify-center gap-4 mt-8 flex-wrap">
                ...
                {/* <div className="animate-pulse">
                  <svg
                    ...
                    xmlSpace="preserve"
                  >
                    <g fill="#231f20" transform="translate(-70.681 -1260.984)">
                      <g>
              ...
              <div className="flex items-center justify-between w-full mt-4">
                ...
                >
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="size-6 text-modalSVGCancel"
                  >
                    <path
                      strokeLinecap="round"
                ...
                <button type="submit" className="hover:animate-pulse">
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="size-6 text-modalSVGSubmit"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"

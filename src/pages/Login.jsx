      ...
      >
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-backgroundBody px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            />
            <div className="mb-10 mt-4 sm:mx-auto sm:w-full sm:max-w-md">
              <h3 className="text-center text-3xl font-bold leading-9 tracking-tight text-mainSVG">
            ...
            <form onSubmit={verifyLogin} className="space-y-6">
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="block w-full rounded-md border-0 py-1.5 text-text bg-background shadow-sm ring-1 ring-inset ring-inputField placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-accentColorDark sm:text-sm sm:leading-6"
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md bg-accentColorDark px-3 py-1.5 text-sm font-semibold leading-6 text-backgroundBody shadow-sm hover:bg-accentColorLight focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accentColorLight"
                >
                  Sign in
                </button>
              </div>
            ...
            {/* <div>
              <div className="relative mt-10">
                <div className="flex items-center justify-center">
                  ...
                  <span className="mx-4 text-sm font-medium leading-6 text-mainSVG px-6 whitespace-nowrap">
                    Or continue with
                  </span>
                  <div className="w-full border-t border-gray-200" />
                </div>
